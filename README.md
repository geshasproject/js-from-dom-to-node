...
To run your code, you can type `nodejs index.js`. `nodejs` is the node code runner and `index.js` is the name of your file. But before you do this, save your index.file (Ctrl+s on Windows). You should see:
